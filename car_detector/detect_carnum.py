...
#등록된 차량 번호 ( 장애인 차량 )
'''
registered_car=['58우 2917','63두9655','42구 9833','67도 5104','232다 2461'] 
'''
...
img_path = 'C:/Users/afrom/car_image/car_num{}.jpg'.format(car_number) # 확장자를 추가해주세요
...
##
'''
if chars in registered_car:
    print('registered car')
    print(chars)
else:
    print('non-registered car')
'''
print('감지된 차량의 번호 : {}'.format(chars))
detected_carnum = chars